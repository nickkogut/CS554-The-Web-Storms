                        ...
                        {loadingGames ? (
                            ...
                            <Stack spacing={2}>
                                {games.map((game, index) => {
                                    ...
                                    const rankColor =
                                        playerEntry.rank === 1 ? "#FFD700" :
                                        playerEntry.rank === 2 ? "#C0C0C0" :
                                        playerEntry.rank === 3 ? "#CD7F32" : "default";
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <Stack direction="row" spacing={3} alignItems="center">
                                                    <Box textAlign="center">
                                                        <Typography variant="h5" fontWeight="bold" sx={{ color: rankColor !== "default" ? rankColor : "text.primary" }}>
                                                            #{playerEntry.rank}
                                                        </Typography>
                                                        <Typography variant="caption" color="text.secondary">
                                                            of {game.numPlayers}
